...
Author: Tom Ordonez
Status: published
Summary: This is a tutorial about unit testing in Python.
...
* To read the source code for `mock` go <a href="https://github.com/python/cpython/blob/3.7/Lib/unittest/mock.py" target="_blank">here</a>.
* Get all the details about <a href="https://docs.python.org/3/library/unittest.html" target="_blank">unittest</a>.